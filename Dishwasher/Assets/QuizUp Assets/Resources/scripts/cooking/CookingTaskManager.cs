...
public class CookingTaskManager : MonoBehaviour
{

    public static int newhighscore;

    public Animator cauliflowerAnimation;
    public Animator capcicumAnimation;
    public Animator fruitsAnimation;
    public Animator tomatoAnimation;
    public Animator broccoliAnimation;
